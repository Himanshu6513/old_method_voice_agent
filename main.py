...
async def handle_tool_invocation(response, openai_ws):
    ...
    if response.get('type') == 'response.done':
        ...
        if output:
            # Extract function call item from the output
            function_call = output[0]
            if function_call.get('type') == 'function_call' and function_call.get('name') == 'fetch_weather':
                # Parse arguments (city)
                ...
                if city:
                    ...
                    tool_response = {
                        ...
                        "item": {
                            ...
                            "call_id": call_id,
                            "output": weather_info  # Weather info as a plain string
                        }}
...
def fetch_weather(city):
    ...
    try:
        ...
        return f"Current weather of {response.text}"
